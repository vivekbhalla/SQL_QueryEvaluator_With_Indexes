...
public class OperatorOrderBy {
	...
	private final OrderByElement col;

	public OperatorOrderBy(LinkedHashMap<Integer, List<Tuple>> instream,
			OrderByElement col) {
	...
	public LinkedHashMap<Integer, List<Tuple>> calculateOrderBy() {
		...
		TreeMap<String, List<Tuple>> orderedString = new TreeMap<String, List<Tuple>>(
		...
		TreeMap<Long, List<Tuple>> orderedLong = new TreeMap<Long, List<Tuple>>(
				new Comparator<Long>() {
					@Override
		...
		TreeMap<Double, List<Tuple>> orderedDouble = new TreeMap<Double, List<Tuple>>(
		...
		TreeMap<Date, List<Tuple>> orderedDate = new TreeMap<Date, List<Tuple>>(
				new Comparator<Date>() {
					@Override
		...
		TreeMap<Time, List<Tuple>> orderedTime = new TreeMap<Time, List<Tuple>>(
				new Comparator<Time>() {
					@Override
		...
		TreeMap<Timestamp, List<Tuple>> orderedTimestamp = new TreeMap<Timestamp, List<Tuple>>(
